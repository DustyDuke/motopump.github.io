...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/docs/3.3/customize/?id=bfb778c956e3332df30574238f60c904)
 * Config saved to config.json and https://gist.github.com/bfb778c956e3332df30574238f60c904
 */
...
$(document).ready(function(){
    $('.article a').click(function() {   
        ...
        var tab = $(this).attr('href');
        $('.subarticle').not(tab).css({'display':'none'});
        $(tab).slideToggle();
    });
});
